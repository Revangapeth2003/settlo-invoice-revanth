...
// FIXED: Pre-save middleware that respects manual status updates
InvoiceSchema.pre('save', function(next) {
  // If status was manually modified to 'Paid', don't override it
  if (this.isModified('status') && this.status === 'Paid') {
    // Ensure amounts are consistent with Paid status
  ...
  if (this.paymentType === 'Full Payment') {
    ...
    // Only auto-set status if it wasn't manually modified
